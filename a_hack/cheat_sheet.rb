...
Cross-Site Scripting (XSS) Inject malicious JavaScript into a webpage barcode
...
What to Look For
Data or text you provided is reflected back to you on the page. If that data isn't properly encoded, an XSS vulnerability might be present. 
Examples:
